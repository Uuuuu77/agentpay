...
export const serviceDefinitions: ServiceDefinition[] = [
  ...
  },
  {
    ...
    description: "Free AI-powered research and insights delivered to your inbox",
    basePrice: 0,
    options: {
      researchDepth: {
        type: "select",
        ...
        options: ["Overview", "Intermediate", "Detailed"],
        priceModifier: 0,
      },
      deliveryFormat: {
        type: "select", 
        ...
        default: "Report",
        options: ["Report", "Summary", "Bullets", "Comparison", "Roadmap"],
        priceModifier: 0,
      },
      industry: {
        type: "select",
        label: "Industry focus",
        default: "Technology",
        options: ["Technology", "Healthcare", "Finance", "E-commerce", "Education", "Marketing", "Other"],
        priceModifier: 0,
      },
    },
    deliverables: ["Research report (HTML)", "Key findings summary", "Actionable recommendations", "Source references"],
    slaHours: 4,
    badge: "FREE",
    maxPerDay: 3,
  },
